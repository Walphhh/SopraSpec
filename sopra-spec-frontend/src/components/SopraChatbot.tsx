                ...
                >
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between p-3 bg-[#0072CE] text-white rounded-t-lg">
                            <span className="font-semibold">SOPRA Assistance</span>
                            <button
                        ...
                        <div className="flex-1 p-4 overflow-y-auto space-y-3">
                            <div className="flex items-start space-x-2">
                                ...
                                <div className="bg-gray-100 rounded-lg text-sm max-w-[80%]">
                                    <p>
                                        Hello! I'm <strong>SOPRA</strong>, your personal project assistant. I’ll be available soon to help you with your projects. Stay tuned!
                                    </p>
                                </div>
                            </div>
                        </div>
